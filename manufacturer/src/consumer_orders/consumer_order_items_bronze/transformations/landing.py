...
input_file_path=r"/Volumes/dev/00_landing/data/consumer_order_items/"
catalog="dev"
schema="00_landing"

dp.create_streaming_table(name=f"{catalog}.{schema}.consumer_order_items_raw_stream")
...
dp.create_streaming_table(f"{catalog}.{schema}.consumer_order_items_cdc_stream")
